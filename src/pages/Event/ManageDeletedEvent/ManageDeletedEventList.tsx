...
import { manageDelete } from "./ManageDeletedEvent";
...
const ManageDeletedEventList: React.FC<Props> = ({
    data,
    getManageEvent,
    totalSize,
    selectRow,
    ...
    const expandRow = {
        renderer: (row: any) => (
            <div className="collapsable-table collapsable-member-delete-table ">
    ...
    return (
        <>
            <div className="member-list-tables manage-event-list manage-delete-event-list manage-application-list">
                <RemotePagination
                    data={data}
                    columns={columns}
                    totalSize={totalSize}
...
export default ManageDeletedEventList;
